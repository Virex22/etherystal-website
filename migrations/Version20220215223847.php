 ...
 */
final class Version20220215223847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE color ADD name VARCHAR(50) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE color DROP name, CHANGE color_preview color_preview VARCHAR(10) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE etherystal CHANGE name name VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE material_instance_name material_instance_name VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE property property LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
